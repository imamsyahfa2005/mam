const A187 = 'Choper'; // JANGAN UBAH-UBAH INFO!!!
const instagram = 'https://instagram.com/serenyemnyem'; // JANGAN UBAH-UBAH INFO!!!
const nomer = 'Wa.me/+6285779386736'; // JANGAN UBAH-UBAH INFO!!!
const aktif = '19.30-23.00'; // JANGAN UBAH-UBAH INFO!!!
const groupwhatsapp = 'https://chat.whatsapp.com/FPveeKtkbNaGo2BfPC5hcx'; // JANGAN UBAH-UBAH INFO!!!
const youtube = 'https://chat.whatsapp.com/KOLxngyc6EeC9a4Rp84sC6'; // JANGAN UBAH-UBAH INFO!!!
//A187ID
...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] SCAN DAH, By @serenyemnyem`);
});
